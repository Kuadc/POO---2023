...
class Aplicacion(tk.Tk):
    ...
    def __init__(self):
        ...
        tk.Button(Framebotones,text="Calcular",bg="green", command=self.cambiaValorMM).pack(padx=20,pady=20,ipadx=10,side=tk.LEFT,fill=tk.BOTH)
        tk.Button(Framebotones,text="Salir",bg="red",borderwidth=3,command=self.destroy).pack(padx=20,pady=20,ipadx=20,side=tk.LEFT,fill=tk.BOTH)
